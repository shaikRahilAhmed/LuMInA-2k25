...
import TechBackground from '../components/TechBackground' // make sure path is correct

const AboutPage = () => {
  return (
    <div className='mt-15 min-h-screen px-6 py-20 relative'>
      {/* Background stars */}
      <TechBackground />
          ...
          <div className='relative bg-zinc-900/70 backdrop-blur-sm border border-red-500/30 rounded-3xl p-8 md:p-12'>
            <div className='space-y-6'>
              ...
              <div className='text-gray-300 text-base md:text-lg leading-relaxed space-y-4'>
                <p>
                  LuMInA 2K25 is a vibrant two-day tech and cultural extravaganza organized by the{' '}
                  <span className='text-red-400 font-medium'>Department of Artificial Intelligence &amp; Machine Learning</span>{' '}
                  at{' '}
                  <span className='text-orange-400 font-medium'>St. Martin&apos;s Engineering College</span>. It celebrates
                  innovation, creativity and teamwork, giving every student a platform to explore their interests and showcase
                  their talents.
                </p>

                <p>
                  Beginning with a traditional inauguration and culminating in dazzling performances, LuMInA blends technical
                  challenges with artistic expression. From quizzes, debates and gaming to music, dance and theme walks, it
                  promises learning, networking and entertainment all in one place.
                </p>
