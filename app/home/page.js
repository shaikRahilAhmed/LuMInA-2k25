            ...
            <div className='max-w-6xl mx-auto pb-20'>
                ...
                <div className='text-center mb-12'>
                    ...
                    <div className='flex justify-center mt-4'>
                        <div className='w-32 h-1 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 rounded-full'></div>
                    </div>
                </div>
                ...
                <div className='flex justify-center mb-12'>
                    <div className='relative group'>
                        <div className='absolute inset-0 bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-purple-500/20 rounded-2xl blur-2xl group-hover:blur-3xl transition-all duration-500'></div>
                        <div className='relative border border-cyan-500/30 rounded-2xl overflow-hidden backdrop-blur-sm'>
                            <Image 
                                src="/smec.jpeg"
                ...
                <div className='max-w-4xl mx-auto text-center'>
                    <p className='text-gray-400 text-base md:text-lg leading-relaxed font-light'>
                        St. Martin&apos;s Engineering College (SMEC), established in <span className='text-cyan-400 font-medium'>2002</span> and located at Dhulapally near Kompally, Hyderabad, is a premier autonomous engineering institution affiliated with <span className='text-blue-400 font-medium'>JNTU Hyderabad</span>. Accredited by AICTE, NBA and awarded <span className='text-purple-400 font-medium'>NAAC A+ status</span>, SMEC prides itself on academic rigor and modern infrastructure. Spanning a well-equipped campus of about 17 acres, it offers cutting-edge labs, library resources, sports facilities and student services. With strong industry tie-ups, consistent placement records and holistic student development, SMEC stands as a beacon of <span className='text-pink-400 font-medium'>quality education</span> in Hyderabad.
                    </p>
                </div>
                ...
                <div className='mb-16'>
                    <h2 className='text-3xl md:text-4xl font-bold text-center mb-12'>
                        ...
                        <div className='flex justify-center mt-4'>
                        <div className='mt-1 w-32 h-1 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 rounded-full'></div>
                    </div>
                    </h2>
                    ...
                    <div className='mt-10 mb-16 flex flex-col md:flex-row gap-8 items-center'>
                        <div className='relative group flex-shrink-0 w-64'>
                            <div className='absolute inset-0 bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-purple-500/20 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500'></div>
                            <div className='relative border border-cyan-500/30 rounded-2xl overflow-hidden backdrop-blur-sm'>
                                <Image
                                    src="/directorSir.png"
                            ...
                            <p className='text-center mt-3 text-base font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent'>
                                Dr. Ravindra Kasa
                            </p>
                    ...
                    {/* HOD - Image Left, Content Right */}
                    <div className='flex flex-col md:flex-row gap-8 items-center'>
                        <div className='relative group flex-shrink-0 w-48'>
                            <div className='absolute inset-0 bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-red-500/20 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500'></div>
                            <div className='relative border border-purple-500/30 rounded-2xl overflow-hidden backdrop-blur-sm'>
                                <Image
                                    src="/hod.png"
                                    alt="Dr. N. Krishnaiah"
                                    width={150}
                            ...
                            <p className='text-center mt-3 text-base font-semibold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent'>
                                Dr. N. Krishnaiah
                            </p>
